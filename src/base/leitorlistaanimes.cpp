...
leitorlistaanimes::~leitorlistaanimes() {
  fdeletaListaAnimes();
  //    qDeleteAll(vlistaWatching.begin(),vlistaWatching.end()); //Deletar todas
  //    as listas qDeleteAll(vlistaCompleted.begin(),vlistaCompleted.end());
  //    //Deletar todas as listas
  //    qDeleteAll(vlistaDropped.begin(),vlistaDropped.end()); //Deletar todas
  //    as listas qDeleteAll(vlistaOnHold.begin(),vlistaOnHold.end()); //Deletar
  //    todas as listas
  //    qDeleteAll(vlistaPlanToWatch.begin(),vlistaPlanToWatch.end()); //Deletar
  //    todas as listas qDeleteAll(vlistaBusca.begin(),vlistaBusca.end());
  //    //Deletar todas as listas
}

leitorlistaanimes *leitorlistaanimes::instance() {
  return Singleton<leitorlistaanimes>::instance(
      leitorlistaanimes::createInstance);
}
    ...
    while (!json.atEnd()) {
      ...
      if (llinha.contains("\"large\":")) {
        ...
        while (!llinha.contains("],")) {
          ...
          // Checa se existem aspas no título do anime, como Sing "YESTERDAY" to
          // me e mantem apenas as aspas do título
          if (llinha.contains("\\\"")) {
            llinha.remove("\"");
            llinha.replace("\\", "\"");
          } else
...
void leitorlistaanimes::fdeletaListaAnimes() {
  ...
  //    if(!vlistaAnimeSeasonWinter.isEmpty()){
  //        qDeleteAll(vlistaAnimeSeasonWinter.begin(),vlistaAnimeSeasonWinter.end());
  //        //Deletar todas as listas vlistaAnimeSeasonWinter.clear();
  //    }
  //    if(!vlistaAnimeSeasonSummer.isEmpty()){
  //        qDeleteAll(vlistaAnimeSeasonSummer.begin(),vlistaAnimeSeasonSummer.end());
  //        //Deletar todas as listas vlistaAnimeSeasonSummer.clear();
  //    }
  //    if(!vlistaAnimeSeasonFall.isEmpty()){
  //        qDeleteAll(vlistaAnimeSeasonFall.begin(),vlistaAnimeSeasonFall.end());
  //        //Deletar todas as listas vlistaAnimeSeasonFall.clear();
  //    }
  //    if(!vlistaAnimeSeasonSpring.isEmpty()){
  //        qDeleteAll(vlistaAnimeSeasonSpring.begin(),vlistaAnimeSeasonSpring.end());
  //        //Deletar todas as listas vlistaAnimeSeasonSpring.clear();
  //    }
}
...
QVector<anime *> leitorlistaanimes::retornaListaAnimeWinter() {
  return vlistaAnimeSeasonWinter;
}

QVector<anime *> leitorlistaanimes::retornaListaAnimeSpring() {
  return vlistaAnimeSeasonSpring;
}

QVector<anime *> leitorlistaanimes::retornaListaAnimeSummer() {
  return vlistaAnimeSeasonSummer;
}

QVector<anime *> leitorlistaanimes::retornaListaAnimeFall() {
  return vlistaAnimeSeasonFall;
}

QVector<anime *> leitorlistaanimes::retornaListaBusca() { return vlistaBusca; }
